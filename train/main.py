...
def main(args):
    ...
    nw = min([os.cpu_count(), batch_size if batch_size > 1 else 0, 8])  # 确定数据加载器的 worker 数量
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default=r"G:\ZDQ\scene\dataset\scene_new_7_11_augmentation")
